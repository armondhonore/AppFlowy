# Nexlayer — swift-vale-appflowy

**Live:** [https://relaxed-weasel-swift-vale-appflowy.cloud.nexlayer.ai](https://relaxed-weasel-swift-vale-appflowy.cloud.nexlayer.ai)  

**Runtime:** docs · **Port:** 80 · **Deploy branch:** main

---

## How this deployment works

**swift-vale-appflowy** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: swift-vale-appflowy
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/appflowy:19f1ff92230"
      path: /
      servicePorts:
        - 80
      vars: {}
...
> The container exposes port 80. When adding a new service (database, cache,
